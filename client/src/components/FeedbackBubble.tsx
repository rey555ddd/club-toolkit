...
const SITE_LABEL = "club.reyway.com 帝豪工具箱";
const REPO_NAME = "rey555ddd/club-toolkit";
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: "rgba(240,192,64,0.15)", background: "oklch(0.08 0.01 260)" }}
          >
            <div className="flex items-center gap-2">
              <span className="text-lg">💡</span>
              <div>
                <div className="text-sm font-bold" style={{ color: "rgba(240,192,64,1)" }}>
                  Bug 回報 / 許願池
                </div>
          ...
          {/* Tabs */}
          <div className="flex border-b" style={{ borderColor: "rgba(240,192,64,0.15)" }}>
            {(["bug", "wish"] as Kind[]).map((k) => (
              <button
                ...
                style={{
                  borderBottomColor: kind === k ? "rgba(240,192,64,1)" : "transparent",
                  color: kind === k ? "rgba(240,192,64,1)" : "rgba(255,255,255,0.45)",
                  background: kind === k ? "rgba(240,192,64,0.06)" : "transparent",
                }}
              >
                {k === "bug" ? (
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background = "rgba(240,192,64,1)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background = "rgba(240,192,64,0.85)";
              }}
            >
